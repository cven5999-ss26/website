...
2. You can create these directories by:
   ...
   - Or using the terminal/console with: `dir.create("data")`, `dir.create("data/raw")`, `dir.create("data/processed")`, and `dir.create("docs")`
...
8. **Complete the template**: Fill out all sections of the README template with information about your specific dataset:

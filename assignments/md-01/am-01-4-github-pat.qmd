...
::: {.callout-note}
## Screenshots may show a previous course
Some screenshots in this assignment may show a previous course iteration. The steps are identical; follow the written instructions.
:::

::: {.callout-tip}
## Struggling with the setup of GitHub?
{{< fa envelope-circle-check >}} If you need support to set up GitHub, get in touch with the course instructor and we will schedule a call to walk through it together.
:::

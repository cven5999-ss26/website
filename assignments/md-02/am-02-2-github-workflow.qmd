...
The screenshots in this assignment were taken in a previous course (`ds4owd-002`). The steps are identical. Follow the written instructions and use your own repository and workspace names, for example `cven5999-ss26` wherever a screenshot shows `ds4owd-002` (such as the Posit Cloud workspace name).
:::
...
- Replace the placeholder [Your Name]{.highlight-yellow} with your first and last name
- Replace [Your Email]{.highlight-yellow} with the email address associated with your GitHub account
- Keep the quotes!

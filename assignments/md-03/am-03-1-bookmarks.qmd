...
::: {.callout-warning}
## Screenshots show a previous course
The screenshots in this assignment were taken in a previous course (`ds4owd-002`). The steps are identical. Follow the written instructions and use your own repository and workspace names, for example `cven5999-ss26` wherever a screenshot shows `ds4owd-002`.
:::
...
3. [Canvas course page]{.highlight-yellow}: [{{< var platforms.canvas >}}]({{< var platforms.canvas >}})
...
7. In the [Add a description]{.highlight-yellow} field:

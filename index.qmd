...
Summer Online - Session C - May 25, 2026 - July 17, 2026; Monday 2:30 - 5:00 pm CET / 6:30 - 9:00 am MT

Instructor: [Lars Schöbitz](https://www.linkedin.com/in/larsschoebitz/)

Canvas: [{{< var platforms.canvas >}}]({{< var platforms.canvas >}})
...
readr::read_csv("data/tbl-01-course-schedule.csv") |> 
  dplyr::select(date, module, topic = title, note) |> 
...
|----------|-------------------------------------------|
| **Monday**   |  Lecture              |
| **Tuesday**  | Self-paced work on homework assignments |
| **Wednesday** | Self-paced work on homework assignments |
| **Thursday** |       Feedback (grading) on assignments from previous module   |
| **Friday**   | Homework assignment and learning reflection are due             |

# Assignments

**Homework assignments**: Each module will have at least one homework assignment. All assignments except those for Module 1 are delivered as Quarto documents with instructions and some sample code. Students are required to submit their work through GitHub. Homework assignments are graded as pass/fail (100 points).

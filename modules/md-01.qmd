...
This first module will be used to get you set up for the course. Work through the homework assignments one after the other.
...
These homework assignments are pre-requisites for Module 2. Complete them by [**{{< var md-01.homework-due >}}**]{.highlight-yellow} to receive the points for this assignment.

...
A repository for each student is established during Module 5 of the course (see [HW 04b: Capstone Project Setup](../assignments/hw-04b-capstone-project-setup.qmd)). Students begin exploring their data and performing initial tidying in Module 6 (see [HW 05: Project Data Exploration](../assignments/hw-05-project-data-exploration.qmd)). This repository contains self-identified data that was shared in Module 4 of the course. Some data cleaning steps may be performed by the course instructor, so that each student has a tidy dataset to work with.

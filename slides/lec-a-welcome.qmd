...
![](img/lec-a/lars_schoebitz_profile_photo.jpg){fig-alt="Headshot of Lars Schöbitz" fig-align="center"}
:::
...
![](img/lec-a/items-slide/items-slide.001.png)
...
![](img/lec-a/starwars-rey-rstats.png)
...
## - {background-image="img/lec-a/illustration-slides/illustration-slides.001.png"}

## - {background-image="img/lec-a/illustration-slides/illustration-slides.002.png"}

## - {background-image="img/lec-a/illustration-slides/illustration-slides.003.png"}

## - {background-image="img/lec-a/illustration-slides/illustration-slides.004.png"}

## - {background-image="img/lec-a/illustration-slides/illustration-slides.005.png"}

## - {background-image="img/lec-a/illustration-slides/illustration-slides.006.png"}

## - {background-image="img/lec-a/illustration-slides/illustration-slides.007.png"}
...
![](img/lec-a/bram-naus-N1gUD_dCvJE-unsplash.jpg)

::: footer
Photo by [Bram Naus](https://unsplash.com/photos/N1gUD_dCvJE)
:::
...
![](img/lec-a/daniel-korpai-vHVfpi3h5xk-unsplash.jpg)

::: footer
Photo by [Daniel Korpai](https://unsplash.com/photos/vHVfpi3h5xk)
:::
...
![](img/lec-a/github-invitation.png)
...
knitr::include_graphics("img/lec-a/phd_comics_vc.gif")
```
...
knitr::include_graphics("img/lec-a/git-logo.png")
```
...
::: {.column width="50%"}
```{r echo=FALSE, out.width="25%"}
knitr::include_graphics("img/lec-a/github-logo.png")
```
- GitHub is a hosting platform for version control using Git
- Launched in 2008, acquired by Microsoft in 2018 for US$ 7.5 billion
- More than [100 million users](https://github.com/about)
...
## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.001.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.002.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.003.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.004.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.005.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.006.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.007.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.008.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.009.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.010.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.011.png" background-size="contain"}

## {background-image="img/lec-a/illustration-slides-git/illustration-slides-git.012.png" background-size="contain"}
...
## - {background-image="img/lec-a/data-science-lifecycle/data-science-lifecycle.001.png" background-size="contain"}

## - {background-image="img/lec-a/data-science-lifecycle/data-science-lifecycle.002.png" background-size="contain"}
...
## - {background-image="img/lec-a/data-science-lifecycle/data-science-lifecycle.003.png" background-size="contain"}
...
## - {background-image="img/lec-a/data-science-lifecycle/data-science-lifecycle.004.png" background-size="contain"}
...
## - {background-image="img/lec-a/data-science-lifecycle/data-science-lifecycle.005.png" background-size="contain"}
...
## - {background-image="img/lec-a/data-science-lifecycle/data-science-lifecycle.006.png" background-size="contain"}
...
## - {background-image="img/lec-a/data-science-lifecycle/data-science-lifecycle.007.png" background-size="contain"}

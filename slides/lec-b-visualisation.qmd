...
```{r}
#knitr::include_graphics(here::here("slides/img/lec-b/ggplot2-part-of-tidyverse.png"))
```
...
Access slides as [PDF on GitHub]({{< var course.github-org >}}/website/raw/main/slides/lec-b-visualisation.pdf)

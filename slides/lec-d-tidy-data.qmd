...
# The homework repo (md-06) consumes a copy of this rds; nothing in this deck
# reads it, so the write is disabled to avoid rewriting the file on every render.
# waste_data_tidy |>
...
## Summarise? Argh!!!! {.smaller auto-animate="true"}
...
2. You will find a repository titled: **md-06-USERNAME** (with your GitHub Username)
...
## . {background-image="img/lec-d/tidydata_1.jpg" background-size="contain"}
...
## . {background-image="img/lec-d/tidydata_2.jpg" background-size="contain"}

::: aside
Illustrations from the [Openscapes](https://www.openscapes.org/) blog [Tidy Data for reproducibility, efficiency, and collaboration](https://www.openscapes.org/blog/2020/10/12/tidy-data/) by [Julia Lowndes](https://twitter.com/juliesquid) and [Allison Horst](https://twitter.com/allison_horst)
:::

## . {background-image="img/lec-d/tidydata_3.jpg" background-size="contain"}
...
::: columns
::: {.column width="40%"}
```{r tidyr-part-of-tidyverse, echo=FALSE, out.width="60%"}
knitr::include_graphics("img/lec-d/tidyr-part-of-tidyverse.png")
```
:::
...
```{r}
knitr::include_graphics("img/lec-d/tidyr-longer-wider.gif")
```
...
# Homework Module 6 {background-color="#0F4C81"}

## Homework due dates

-   All material on [course website]({{< var course.site >}}modules/md-06.html)

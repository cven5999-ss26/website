...
works <- read_csv(here::here("data/scientists/works.csv"))
```
...
include_graphics("img/lec-e/left-join.gif")
```
:::
...
::: {.column width="47.5%"}
```{r echo=FALSE, out.width="80%", out.extra ='style="background-color: #FDF6E3"'}
include_graphics("img/lec-e/right-join.gif")
```
:::
...
#| eval: false
professions %>%
  right_join(dates, by = join_by(name))
```
...
::: {.column width="47.5%"}
```{r echo=FALSE, out.width="80%", out.extra ='style="background-color: #FDF6E3"'}
include_graphics("img/lec-e/full-join.gif")
```
:::
...
#| eval: false
dates %>%
  full_join(works, by = join_by(name))
```
...
![](img/lec-e/publisher-policies-01.drawio.svg)

##

![](img/lec-e/publisher-policies-02.drawio.svg)

##

![](img/lec-e/publisher-policies-03.drawio.svg)

##

![](img/lec-e/publisher-policies-04.drawio.svg)

##

![](img/lec-e/publisher-policies-05.drawio.svg)

##

![](img/lec-e/publisher-policies-06.drawio.svg)

##

![](img/lec-e/publisher-policies-07.drawio.svg)
...
::: {.fragment .fade-up}
![](img/lec-e/horst_quarto_schematic.png){fig-align="center" width="1100px" fig-alt="A schematic representing the multi-language input (e.g. Python, R, Observable, Julia) and multi-format output (e.g. PDF, html, Word documents, and more) versatility of Quarto."}
:::
...
![](img/lec-e/qmd-knitr.jpeg){.fragment width="1800" fig-alt="diagram of converting a Qmd document via knitr/pandoc into markdown and then into output formats"}

![](img/lec-e/qmd-jupyter.jpeg){.fragment width="1800" fig-alt="diagram of converting a Quarto document via Jupyter/pandoc into markdown and then into output formats"}
...
[![](img/lec-e/website-quarto.png){fig-alt="Screenshot of the Quarto homepage at https://quarto.org/." fig-align="center"}](https://quarto.org/)
...
2. Locate the **md-07-writing** repository with your username `md-07-writing-GITHUB-USERNAME`
...
# Homework Module 7 {background-color="#0F4C81"}

## Homework due dates

- All material on [course website]({{< var course.site >}}modules/md-07.html)
...
- All material on [course website]({{< var course.site >}}modules/md-08.html)
- Due date for report: [**{{< var md-08.homework-due >}}**]{.highlight-yellow}
